...
class MainActivity : AppCompatActivity() {
    ...
    private fun setupRecyclerView(recyclerView: RecyclerView) {
        var vloAdapter = SerieViewAdapter(this,mMovie, twoPane, recyclerView)
    ...
    class SerieViewAdapter(private val parentActivity: MainActivity,
                           private val mMovievalues: ArrayList<Moovie_DB>,
        ...
        override fun onBindViewHolder(holder: ViewHolder, position: Int) {
            ...
            holder.mPosterImageView?.let {
                Glide.with(holder.itemView.context).load(movie.url).preload()
